...
namespace CSC2037_SportsPro_Ch15.Migrations
{
    ...
    [Migration("20221014221135_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CustomerProduct", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            CustomersCustomerID = 1010,
                            ProductsProductID = 2
                        });
                });

            modelBuilder.Entity("CSC2037_SportsPro_Ch15.Models.Country", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_SportsPro_Ch15.Models.Customer", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_SportsPro_Ch15.Models.Incident", b =>
                {
            ...
            modelBuilder.Entity("CSC2037_SportsPro_Ch15.Models.Product", b =>
                {
                    b.Property<int>("ProductID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CSC2037_SportsPro_Ch15.Models.Technician", b =>
                {
                    b.Property<int>("TechnicianID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CustomerProduct", b =>
                {
                    b.HasOne("CSC2037_SportsPro_Ch15.Models.Customer", null)
                        .WithMany()
                        .HasForeignKey("CustomersCustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_SportsPro_Ch15.Models.Product", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CSC2037_SportsPro_Ch15.Models.Customer", b =>
                {
                    b.HasOne("CSC2037_SportsPro_Ch15.Models.Country", "Country")
                        .WithMany()
            ...
            modelBuilder.Entity("CSC2037_SportsPro_Ch15.Models.Incident", b =>
                {
                    b.HasOne("CSC2037_SportsPro_Ch15.Models.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_SportsPro_Ch15.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CSC2037_SportsPro_Ch15.Models.Technician", "Technician")
                        .WithMany()
